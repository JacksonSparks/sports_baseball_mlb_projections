...
def main():
    ...
    df1 = pd.read_csv('batter_team_matchups_b.csv')
    df2 = pd.read_csv('batter_pitcher_matchups_c.csv')
    ...
    merged_df.to_csv('batter_team_matchups_c.csv', index=False)

    # Print a message to indicate the process is complete
    print("Merged CSV file 'batter_team_matchups_c.csv' has been created successfully.")
