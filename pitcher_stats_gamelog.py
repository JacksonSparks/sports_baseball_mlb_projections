...
def scrape_box_score(box_score_url):
    try:
        ...
        if away_pitcher_stats and home_pitcher_stats:
            ...
            away_pitcher_walks = away_pitcher_stats[4].text.strip()
            away_pitcher_ks = away_pitcher_stats[5].text.strip()
            home_pitcher_innings = home_pitcher_stats[0].text.strip()
            home_pitcher_runs = home_pitcher_stats[3].text.strip()
            home_pitcher_walks = home_pitcher_stats[4].text.strip()
            home_pitcher_ks = home_pitcher_stats[5].text.strip()
...
def main():
    ...
    if all_game_data:
        save_to_csv('k_gamelog.csv', all_game_data)
        print("Scraped data saved to k_gamelog.csv")
    else:
